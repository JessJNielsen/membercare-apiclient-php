...
/**
 * RegistrationCategory Class Doc Comment
 *
 * @category Class
 * @package  Membercare\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegistrationCategory implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegistrationCategory';
     ...
     * Sets id
     *
     * @param int $id The identification id of the registration category.
     *
     * @return $this
     */
     ...
     *
     * @param string $registration_name The name of the registration category.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The description of the registration category.
     *
     * @return $this
     */
     ...
     * Sets abnormal
     *
     * @param bool $abnormal Indicates whether or not this registration is estimated or not.
     *
     * @return $this
     */
