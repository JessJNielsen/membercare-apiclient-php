...
/**
 * PersonSearchBoardMemberCriteria Class Doc Comment
 *
 * @category Class
 * @package  Membercare\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PersonSearchBoardMemberCriteria implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PersonSearchBoardMemberCriteria';
    ...
    protected static $swaggerTypes = [
        ...
        'query_items' => '\Membercare\Client\Model\PersonSearchBoardMemberQueryItem[]',
        'valid_on' => '\DateTime'
    ];
     ...
     * Gets query_items
     *
     * @return \Membercare\Client\Model\PersonSearchBoardMemberQueryItem[]
     */
     ...
     * Sets query_items
     *
     * @param \Membercare\Client\Model\PersonSearchBoardMemberQueryItem[] $query_items Person should be a member of board (taking the chosen Match into account)
     *
     * @return $this
     */
     ...
     * Sets valid_on
     *
     * @param \DateTime $valid_on When should the board membership be valid - if not provided we use \"Today\"
     *
     * @return $this
     */
